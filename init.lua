...
require('lazy').setup({
  ...
  --  The configuration is done below. Search for lspconfig to find it below.
  {
    ...
    config = function()
      ...
      require 'custom.lsp.languages.golang'
      require 'custom.lsp.languages.luals'
    end
  },
...

  {
    ...
    ft = "go",
    config = function()
      vim.keymap.set("n", "<leader>jt", "<cmd> GoTagAdd json <CR>", {desc = "Add json struct tags"})
      vim.keymap.set("n", "<leader>yt", "<cmd> GoTagAdd yaml <CR>", {desc = "Add yaml struct tags"})
      vim.keymap.set("n", "<leader>gt", "<cmd> GoTestAdd <CR>", {desc = "Generate test for the specific function"})
      vim.keymap.set("n", "<leader>gta", "<cmd> GoTestsAll <CR>", {desc = "Generate all tests for all functions/methods in current file"})
      vim.keymap.set("n", "<leader>ge", "<cmd> GoIfErr <CR>", {desc = "Generate error handling"})
    end,
